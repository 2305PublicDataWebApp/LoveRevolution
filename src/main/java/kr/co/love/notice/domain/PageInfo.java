...
public class PageInfo {
	...
	public String toString() {
		return "PageInfo [현재페이지=" + currentPage + ", 총개시물갯수=" + totalCount + ", 네비총갯수=" + naviTotalCount
				+ ", 한페이지당 개시물갯수=" + recordCountPerPage + ", 한페이지당 네비갯수=" + naviCountPerPage + ", 시작네비="
				+ startNavi + ", 종료네비=" + endNavi + "]";
	}
}
